...
Unix/Linux 命令、Shell 脚本、终端工具和常用系统配置笔记。

## 目录结构

```
├── disk/             # 磁盘与文件系统工具 (ncdu, yazi)
├── file/             # 文件操作 (edit, find, link, trash, zip)
...
- [鸟哥的 Linux 私房菜：基础学习篇 第四版](https://wizardforcel.gitbooks.io/vbird-linux-basic-4e/content/index.html)
